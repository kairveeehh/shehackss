...
document.getElementById("showSymptoms").addEventListener("click", function() {
  ...
  if (symptomsContent.style.display === "block") {
      ...
      symptomsContent.innerHTML = "<p>Here are some common riskful symptoms during breastfeeding:</p><ul><li>Sore or cracked nipples</li><li>Engorged breasts</li><li>Low milk supply</li><li>Mastitis (breast infection)</li><li>Thrush (yeast infection in the breast)</li></ul>";
  }
});
